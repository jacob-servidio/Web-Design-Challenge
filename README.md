...
The HTML code for each page can be found in the WEB visualization folder, under the file titled for the page and CSS code can be found in the style.css file 
